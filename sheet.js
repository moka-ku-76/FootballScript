...
function getDailyInfo(sheet) {
  ...
  return {
    ...
    winRateWorst3: winRateRanking.worst3.reverse(),
    pointsBest3: pointsRanking.best3,
    pointsWorst3: pointsRanking.worst3.reverse(),
...
function calculateWinRateRanking(records) {
  ...
  return {
    best3: winRates.slice(0, 3),
    worst3: winRates.slice(-3)
  };
}
...
function calculatePointsRanking(records) {
  ...
  return {
    best3: points.slice(0, 3),
    worst3: points.slice(-3)
  };
}
